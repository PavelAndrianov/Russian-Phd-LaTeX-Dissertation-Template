...
% https://git.kernel.org/cgit/linux/kernel/git/stable/linux-stable.git/commit/?id=aea9dd5
% timeout, 300k lock, fs/btrfs/btrfs.ko, 3 потоков, что-то нашлось
% Содержит большое количество функциональных указателей, т.е. не только в потоках дело
...
% https://git.kernel.org/cgit/linux/kernel/git/stable/linux-stable.git/commit/?id=2e4ce49
% timeout, 25k lock, drivers/scsi/hpsa.ko, 13 потоков, что-то нашлось
...
% https://git.kernel.org/cgit/linux/kernel/git/stable/linux-stable.git/commit/?id=4036523
% timeout, 260k lock, drivers/gpu/drm/i915/i915.ko, 24 потока вместо 3-4
