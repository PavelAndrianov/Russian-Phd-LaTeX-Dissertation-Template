...
\begin{figure}[H]
  \center
  \includegraphics[width=0.8\linewidth]{CPATree}
\end{figure}
\end{frame}
...
\begin{figure}[h]
  \begin{minipage}[h]{0.49\linewidth}
    ...
    \center{\includegraphics[width=1\linewidth]{ThreadCPAEnv-img}}
  \end{minipage}
  \hfill
  \begin{minipage}[h]{0.49\linewidth}
    \textbf{Составная \\ подпись 2}
    \center{\includegraphics[width=1\linewidth]{ThreadCPAExt-img}}
  \end{minipage}
\end{figure}
\end{frame}
